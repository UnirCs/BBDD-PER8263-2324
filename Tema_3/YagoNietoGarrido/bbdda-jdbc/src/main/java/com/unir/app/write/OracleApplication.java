...
public class OracleApplication {
    ...
    private static void simpleInsertion(Connection connection) throws SQLException {
        String insertSql = "INSERT INTO departmentsCsv (idDep, name) VALUES ('1111','Departemento de Aeronáutica')";
