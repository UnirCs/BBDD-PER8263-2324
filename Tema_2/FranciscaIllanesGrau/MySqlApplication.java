...
public class MySqlApplication {
    ...
    public static void main(String[] args) {
        ...
        try(Connection connection = new MySqlConnector("localhost", DATABASE).getConnection()) {
            ...
            selectTopPaidEmployeeOfDepartment(connection, "d001");
            selectTopPaidEmployeeOfDepartment(connection, "d002");
            selectSecondTopPaidEmployeeOfDepartment(connection, "d001");
            selectEmployeesHiredInMonth(connection, 5);  // Por ejemplo, para mayo
