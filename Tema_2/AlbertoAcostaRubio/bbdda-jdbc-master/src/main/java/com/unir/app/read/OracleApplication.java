...
public class OracleApplication {
    ...
    public static void main(String[] args) {
        ...
        try(Connection connection = new OracleDatabaseConnector("localhost", SERIVCE_NAME).getConnection()) {
            ...
            selectNombreApellidoDepartamento(connection);
    ...
    private static void selectNombreApellidoDepartamento (Connection connection) throws SQLException {
        ...
        while (empleados.next()) {
            log.debug("Departamento as XML: {}", empleados.getString("EmpleadosXml"));
        }
    }
