    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                configuration.addAnnotatedClass(DeptEmployeeId.class);
                configuration.addAnnotatedClass(DeptManager.class);
                configuration.addAnnotatedClass(DeptManagerId.class);
                configuration.addAnnotatedClass(Salary.class);
                configuration.addAnnotatedClass(SalaryId.class);
                configuration.addAnnotatedClass(Title.class);
                configuration.addAnnotatedClass(TitleId.class);
