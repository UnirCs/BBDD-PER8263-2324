...
public interface DepartmentRepository extends JpaRepository<Department, String> {
    ...
    @Query(value="Select d.* from departments d inner join dept_emp de on d.dept_no = de.dept_no where de.emp_no = :idEmp AND to_date = '9999-01-01'", nativeQuery=true)
    Optional<Department> findByEmpNo(String idEmp);

    Optional<Department> findByDeptNo(String deptName);
